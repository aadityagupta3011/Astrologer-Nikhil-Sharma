...
const LoveRelationshipAdvice = () => {
  const cardData = [
    {
      image: 'public/images/relationshipObstacles.png',
      title: 'Vashikaran Remedies for Overcoming your Relationship Obstacles',
      contact: [' +91-95091-68369', '+44-7452-214792'],
      footerLinks: [
    ...
    {
      image: 'public/images/extramaritalAffairs.png',
    ...
    {
      image: 'public/images/gemStone.png',
          ...
          <div className="flex items-center justify-center h-full bg-black bg-opacity-40">
            <div className="text-center text-white">
              ...
              <div className="text-lg md:text-xl">
                ...
                <p className="text-lg">+44-7452-214792</p>
              </div>
            </div>
          </div>
        </div>
