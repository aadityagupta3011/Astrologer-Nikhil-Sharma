...
const Home = () => {
  const headerData = {
    title:
      "Renownedkit Sharma Ji - Globally Acclaimed for Exceptional Astrological Expertise",
    description:
      "As the accomplished son of a globally renowned figure, Nikhil Sharma, a distinguished Indian astrologer, has risen to become one of the most sought-after and esteemed astrologers and vashik. Throughout his illustrious career spanning decades, he has skillfully applied his expertise in Vedic astrology and benevolent vashikaran to make a profound of life.",
  };
