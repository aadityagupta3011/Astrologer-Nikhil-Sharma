...
const Navbar = () => {
  ...
  return (
    <header className="text-white pt-2 bg-[#a66330]">
      {/* Desktop Navbar */}
      <div className="hidden custom-md:block">
        {/* Top Row */}
        <div className="flex justify-end p-2 text-sm">
          <nav className="space-x-4 mr-5">
            <Link className="hover:bg-gray-400 p-1 transition-all delay-50  rounded-md " to="/Profile">
              Profile
            </Link>
            <Link className="hover:bg-gray-400 p-1 transition-all delay-50  rounded-md " to="/Counseling">
              Counseling
            </Link>
            <Link className="hover:bg-gray-400 p-1 transition-all delay-50  rounded-md " to="/Who-is-Astrologer-Nikhil-Sharma">
              Why Nikhil Ji
            </Link>
            <Link to={"/Yantra"} className="hover:bg-gray-400 p-1 transition-all delay-50  rounded-md " >
              Yantras
            </Link>
          </nav>
        </div>
        ...
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-xl font-semibold">Astrologer Nikhil Sharma</h1>
              <p className="text-sm">Best Astrology & Vashikaran Services</p>
            </div>
          </div>
          <div className="text-right">
            <p>📞 +91-95091-68369 | +44-7452-214792</p>
